<?php
// Inicia a sessão PHP para manter dados do utilizador logado
session_start();
// Verifica se o utilizador tem privilégios de administrador
require '../api/auth.php';
// Se não for admin, redireciona para página principal
if (!isAdmin()) {
...
<head>
    ...
    <!-- Bootstrap CSS para styling responsivo -->
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
        <div class="container">
            ...
            <!-- Botão para menu responsivo em dispositivos móveis -->
    ...
    <div class="container">
        ...
        <?php
        // Inclui conexão com a base de dados
        require_once '../api/db.php';
        // Prepara consulta SQL para buscar produtos (mais seguro que concatenação)
        ...
        $produtos = $result->fetch_all(MYSQLI_ASSOC); // Converte resultados para array associativo
