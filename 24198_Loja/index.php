...
// Operador ternário: se existe 'search' no GET, sanitiza; senão, string vazia
$search = isset($_GET['search']) ? $con->real_escape_string($_GET['search']) : '';
// Consulta SQL para obter produtos, com filtro de pesquisa se fornecido // CONSTRUÇÃO DINÂMICA DA QUERY:
$sql = "SELECT id, nome, descricao, preco, imagem FROM produto";
if ($search !== '') {

    // Se há termo de pesquisa, adiciona filtro com LIKE para pesquisar em nome e descrição
...
<head>
    ...
    <!-- Bootstrap CSS para design responsivo -->
    ...
    <style>
        ...
        body.bg-light {
            background-color: rgb(244, 239, 248) !important;
        }
...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    <!-- LINK CONDICIONAL: Só aparece para administradores -->
                    <?php if (isAdmin()) { ?>
                        <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <!-- ÍCONE DO CARRINHO com SVG embutido -->
            ...
            <?php foreach ($produtos as $produto): ?>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 shadow-sm">
                        ...
                        ?>
                        <!-- IMAGEM RESPONSIVA com altura fixa e object-fit -->
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <form method="post" action="api/add_to_cart.php" class="mt-3 d-flex align-items-center gap-2">
                                    ...
                                    <!-- QUANTIDADE (campo numérico com valor padrão 1) -->
    ...
    <!-- Bootstrap JavaScript para componentes interativos -->
